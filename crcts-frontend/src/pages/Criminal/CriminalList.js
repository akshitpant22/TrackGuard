...
const CriminalList = () => {
  ...
  // ✅ Gender display mapping (handles full and short codes)
  const getGenderDisplay = (genderCode) => {
    ...
    return genderMap[genderCode] || genderCode || 'N/A';
  };
    ...
    return (
      <div style={styles.paginationContainer}>
        ...
        <button
          style={styles.pageNavButton}
          onClick={() =>
            loadPaginatedCriminals(Math.max(1, currentPage - 1))
          }
          disabled={currentPage === 1}
        >
          {'<'}
        ...
        <button
          style={styles.pageNavButton}
          onClick={() =>
            loadPaginatedCriminals(Math.min(totalPages, currentPage + 1))
          }
                ...
                {criminals.length > 0 ? (
                  ...
                  <tr>
                    <td colSpan="8" style={styles.noData}>
                      {searchMode
                        ? 'No criminal found with that ID'
                        : 'No criminals found'}
                    </td>
                  </tr>
                )}
