...
const CourtCaseRecordForm = ({ onCaseRecordAdded, onCaseRecordUpdated, onCancel, editCaseRecord = null }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('📤 Final Case Data:', apiData);
...
export default CourtCaseRecordForm;
